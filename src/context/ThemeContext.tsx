...
export type ThemeMode =
  ...
  | 'digital_matrix' | 'circuit_glow' | 'ai_network' | 'holographic_grid' | 'data_stream' | 'radar_scan'
  | 'floating_balloons' | 'paper_planes' | 'fireplace_glow'
  | 'highway_sunset' | 'bus_window_rain' | 'train_window' | 'metro_ride' | 'bike_ride_pov' | 'auto_rickshaw'
  | 'plane_takeoff' | 'neon_taxi' | 'terrace_friends' | 'road_trip_friends' | 'beach_bonfire' | 'rain_walk'
  | 'sunset_silhouette' | 'street_food' | 'city_timelapse' | 'rain_reflection' | 'street_musician'
  | 'empty_night_road' | 'window_thinking' | 'train_goodbye' | 'train_bridge' | 'lonely_walk'
  | 'city_top_view' | 'bus_stop_rain' | 'fog_street' | 'festival_lights' | 'ferris_wheel' | 'slow_traffic'
  | 'boat_ride' | 'lofi_window' | 'neon_alley' | 'subway_rush' | 'delivery_ride' | 'market_crowd'
  | 'college_walk' | 'rooftop_party' | 'street_dogs' | 'zebra_crossing' | 'truck_night' | 'sunrise_city'
  | 'constellations' | 'jellyfish_glow' | 'rain_ripples' | 'floating_boat' | 'falling_leaves' | 'cherry_petals'
  | 'fireflies' | 'grass_wind' | 'sunrise_sky' | 'three_d_cubes' | 'smoke_waves' | 'aurora_lights'
  | 'matrix_rain' | 'neural_network' | 'hologram_grid' | 'data_streams' | 'balloons' | 'railway_platform';
...
export const themes: Record<ThemeMode, ThemeColors> = {
  ...
  highway_sunset:    { primary: '#f97316', background: '#0d0500', surface: 'rgba(40,15,0,0.7)', surfaceHighlight: 'rgba(249,115,22,0.1)', text: '#fff3e0', textSecondary: '#fb923c', accent: '#fbbf24', border: 'rgba(249,115,22,0.3)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#f97316', '#dc2626', '#0f172a'] },
  bus_window_rain:   { primary: '#64748b', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#334155'] },
  train_window:      { primary: '#94a3b8', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(148,163,184,0.1)', text: '#f1f5f9', textSecondary: '#64748b', accent: '#cbd5e1', border: 'rgba(148,163,184,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  metro_ride:        { primary: '#818cf8', background: '#0a0a0a', surface: 'rgba(30,30,30,0.8)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0f172a', '#1e1b4b'] },
  bike_ride_pov:     { primary: '#0ea5e9', background: '#082f49', surface: 'rgba(12,74,110,0.7)', surfaceHighlight: 'rgba(14,165,233,0.1)', text: '#f0f9ff', textSecondary: '#7dd3fc', accent: '#bae6fd', border: 'rgba(14,165,233,0.2)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#082f49', '#0c4a6e', '#075985'] },
  auto_rickshaw:     { primary: '#fbbf24', background: '#1e293b', surface: 'rgba(51,65,85,0.7)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fef3c7', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#0f172a', '#1c1917'] },
  plane_takeoff:     { primary: '#0284c7', background: '#f0f9ff', surface: 'rgba(255,255,255,0.85)', surfaceHighlight: 'rgba(2,132,199,0.1)', text: '#0c4a6e', textSecondary: '#0369a1', accent: '#38bdf8', border: 'rgba(2,132,199,0.2)', glassBorder: 'rgba(2,132,199,0.05)', isDark: false, gradientColors: ['#f0f9ff', '#e0f2fe', '#bae6fd'] },
  neon_taxi:         { primary: '#f43f5e', background: '#050505', surface: 'rgba(20,20,20,0.8)', surfaceHighlight: 'rgba(244,63,94,0.1)', text: '#fff1f2', textSecondary: '#fb7185', accent: '#fda4af', border: 'rgba(244,63,94,0.3)', glassBorder: 'rgba(244,63,94,0.1)', isDark: true, gradientColors: ['#000000', '#050505', '#1a0a0f'] },
  terrace_friends:   { primary: '#818cf8', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#312e81'] },
  road_trip_friends: { primary: '#7c3aed', background: '#1e293b', surface: 'rgba(51,65,85,0.7)', surfaceHighlight: 'rgba(124,58,237,0.1)', text: '#f5f3ff', textSecondary: '#a78bfa', accent: '#c4b5fd', border: 'rgba(124,58,237,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#7c3aed', '#1e293b', '#000000'] },
  beach_bonfire:     { primary: '#f97316', background: '#082f49', surface: 'rgba(12,74,110,0.7)', surfaceHighlight: 'rgba(249,115,22,0.1)', text: '#fff7ed', textSecondary: '#fb923c', accent: '#fbbf24', border: 'rgba(249,115,22,0.2)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#082f49', '#0c4a6e', '#1c0a00'] },
  rain_walk:         { primary: '#64748b', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  sunset_silhouette: { primary: '#f97316', background: '#0f172a', surface: 'rgba(15,23,42,0.8)', surfaceHighlight: 'rgba(249,115,22,0.1)', text: '#fff7ed', textSecondary: '#fb923c', accent: '#fbbf24', border: 'rgba(249,115,22,0.3)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#f97316', '#dc2626', '#0f172a'] },
  street_food:       { primary: '#fbbf24', background: '#1c1917', surface: 'rgba(41,37,36,0.8)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fef3c7', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1c1917', '#292524', '#1a0d00'] },
  city_timelapse:    { primary: '#fbbf24', background: '#0a0a0a', surface: 'rgba(20,20,20,0.8)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fffbeb', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0a0a0a', '#1c1917'] },
  rain_reflection:   { primary: '#818cf8', background: '#1e293b', surface: 'rgba(51,65,85,0.7)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#0f172a', '#312e81'] },
  street_musician:   { primary: '#fbbf24', background: '#1e293b', surface: 'rgba(51,65,85,0.7)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fef3c7', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#0f172a', '#1c1917'] },
  empty_night_road:  { primary: '#64748b', background: '#0f172a', surface: 'rgba(15,23,42,0.8)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#000000', '#1e293b'] },
  window_thinking:   { primary: '#64748b', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#334155'] },
  train_goodbye:     { primary: '#94a3b8', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(148,163,184,0.1)', text: '#f1f5f9', textSecondary: '#64748b', accent: '#cbd5e1', border: 'rgba(148,163,184,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  train_bridge:      { primary: '#94a3b8', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(148,163,184,0.1)', text: '#f1f5f9', textSecondary: '#64748b', accent: '#cbd5e1', border: 'rgba(148,163,184,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  lonely_walk:       { primary: '#64748b', background: '#1e293b', surface: 'rgba(51,65,85,0.7)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#475569', '#334155'] },
  city_top_view:     { primary: '#fbbf24', background: '#0a0a0a', surface: 'rgba(20,20,20,0.8)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fffbeb', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0a0a0a', '#1c1917'] },
  bus_stop_rain:     { primary: '#64748b', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  fog_street:        { primary: '#94a3b8', background: '#334155', surface: 'rgba(71,85,105,0.8)', surfaceHighlight: 'rgba(148,163,184,0.1)', text: '#f1f5f9', textSecondary: '#64748b', accent: '#cbd5e1', border: 'rgba(148,163,184,0.2)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#334155', '#475569', '#1e293b'] },
  festival_lights:   { primary: '#f43f5e', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(244,63,94,0.1)', text: '#fff1f2', textSecondary: '#fb7185', accent: '#8b5cf6', border: 'rgba(244,63,94,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#1e1b4b'] },
  ferris_wheel:      { primary: '#fbbf24', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fffbeb', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#000000'] },
  slow_traffic:      { primary: '#ef4444', background: '#0a0a0a', surface: 'rgba(20,20,20,0.8)', surfaceHighlight: 'rgba(239,68,68,0.1)', text: '#fff1f2', textSecondary: '#f87171', accent: '#fca5a5', border: 'rgba(239,68,68,0.3)', glassBorder: 'rgba(239,68,68,0.1)', isDark: true, gradientColors: ['#000000', '#0a0a0a', '#1a0000'] },
  boat_ride:         { primary: '#0ea5e9', background: '#082f49', surface: 'rgba(12,74,110,0.7)', surfaceHighlight: 'rgba(14,165,233,0.1)', text: '#f0f9ff', textSecondary: '#7dd3fc', accent: '#bae6fd', border: 'rgba(14,165,233,0.2)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#082f49', '#0c4a6e', '#075985'] },
  lofi_window:       { primary: '#818cf8', background: '#0f172a', surface: 'rgba(30,41,59,0.75)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#312e81'] },
  neon_alley:        { primary: '#f43f5e', background: '#050505', surface: 'rgba(20,20,20,0.8)', surfaceHighlight: 'rgba(244,63,94,0.1)', text: '#fff1f2', textSecondary: '#fb7185', accent: '#8b5cf6', border: 'rgba(244,63,94,0.3)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#050505', '#1a0a0f'] },
  subway_rush:       { primary: '#818cf8', background: '#0a0a0a', surface: 'rgba(30,30,30,0.8)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0f172a', '#1e1b4b'] },
  delivery_ride:     { primary: '#f97316', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(249,115,22,0.1)', text: '#fff7ed', textSecondary: '#fb923c', accent: '#fbbf24', border: 'rgba(249,115,22,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#1a0a00'] },
  market_crowd:      { primary: '#fbbf24', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(251,191,36,0.1)', text: '#fffbeb', textSecondary: '#d97706', accent: '#fcd34d', border: 'rgba(251,191,36,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#1c1917'] },
  college_walk:      { primary: '#d97706', background: '#fffbeb', surface: 'rgba(255,255,255,0.85)', surfaceHighlight: 'rgba(217,119,6,0.1)', text: '#78350f', textSecondary: '#b45309', accent: '#fbbf24', border: 'rgba(217,119,6,0.2)', glassBorder: 'rgba(217,119,6,0.05)', isDark: false, gradientColors: ['#fffbeb', '#fef3c7', '#fde68a'] },
  rooftop_party:     { primary: '#818cf8', background: '#0f172a', surface: 'rgba(30,41,59,0.7)', surfaceHighlight: 'rgba(129,140,248,0.1)', text: '#e0e7ff', textSecondary: '#6366f1', accent: '#a5b4fc', border: 'rgba(129,140,248,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#0f172a', '#1e293b', '#312e81'] },
  street_dogs:       { primary: '#d97706', background: '#1c1917', surface: 'rgba(41,37,36,0.8)', surfaceHighlight: 'rgba(217,119,6,0.1)', text: '#fef3c7', textSecondary: '#b45309', accent: '#fbbf24', border: 'rgba(217,119,6,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1c1917', '#292524', '#1a0d00'] },
  zebra_crossing:    { primary: '#ffffff', background: '#0a0a0a', surface: 'rgba(20,20,20,0.9)', surfaceHighlight: 'rgba(255,255,255,0.05)', text: '#ffffff', textSecondary: '#a3a3a3', accent: '#d4d4d4', border: 'rgba(255,255,255,0.1)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0a0a0a', '#1a1a1a'] },
  truck_night:       { primary: '#64748b', background: '#000000', surface: 'rgba(10,10,10,0.9)', surfaceHighlight: 'rgba(100,116,139,0.1)', text: '#f1f5f9', textSecondary: '#94a3b8', accent: '#cbd5e1', border: 'rgba(100,116,139,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#000000', '#0f172a', '#1e293b'] },
  sunrise_city:      { primary: '#f97316', background: '#f0f9ff', surface: 'rgba(255,255,255,0.85)', surfaceHighlight: 'rgba(249,115,22,0.1)', text: '#7c2d12', textSecondary: '#ea580c', accent: '#fb923c', border: 'rgba(249,115,22,0.2)', glassBorder: 'rgba(249,115,22,0.05)', isDark: false, gradientColors: ['#f97316', '#fbbf24', '#60a5fa'] },
  railway_platform:  { primary: '#94a3b8', background: '#1e293b', surface: 'rgba(51,65,85,0.75)', surfaceHighlight: 'rgba(148,163,184,0.1)', text: '#f1f5f9', textSecondary: '#64748b', accent: '#cbd5e1', border: 'rgba(148,163,184,0.2)', glassBorder: 'rgba(255,255,255,0.05)', isDark: true, gradientColors: ['#1e293b', '#334155', '#0f172a'] },
  ...
  jellyfish_glow:    { primary: '#c084fc', background: '#083344', surface: 'rgba(21,94,117,0.7)', surfaceHighlight: 'rgba(192,132,252,0.1)', text: '#ecfeff', textSecondary: '#a78bfa', accent: '#c084fc', border: 'rgba(192,132,252,0.2)', glassBorder: 'rgba(255,255,255,0.1)', isDark: true, gradientColors: ['#083344', '#155e75', '#1e1b4b'] },
